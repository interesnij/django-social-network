    ...
    for item in post.attach.split(","):
        if item[:3] == "pho":
            ...
            try:
                ...
                video_counter += 1
                if video.community:
                    block = ''.join([block, '<div class="video"><img class="image_fit" src="', video.image.url, '" alt="img"><div class="video_icon_play_v2 c_post_video" video-pk="', str(video.pk), '" video-counter="', video_counter, '"></div></div>'])
                else:
                    block = ''.join([block, '<div class="video"><img class="image_fit" src="', video.image.url, '" alt="img"><div class="video_icon_play_v2 u_post_video" video-pk="', str(video.pk), '" video-counter="', video_counter, '"></div></div>'])
            except:
                pass
        elif item[:3] == "goo":
            try:
            ...
            try:
                ...
                block = ''.join([block, '<div class="music" data-path="', music.uri, '" data-duration="', music.duration, '" style="flex-basis: auto;width:100%;position: relative;"><div class="media" music-counter="', music_counter, '">', figure, '<div class="media-body" style="display: flex;"><h6 class="music_list_post music_title"><a>', music.title, '</a></h6>', span_btn, '</div></div></div>'])
            except:
                pass
        elif item[:3] == "doc":
            try:
