        ...
        if item[:3] == "pho":
            ...
            try:
                ...
                if list.type[0] == "_":
                    pass
                if list.community:
                    creator, name, img_src = list.community, list.community.name, list.community.get_avatar()
                else:
                    creator, name, img_src = list.creator, list.creator.get_full_name(), list.creator.get_avatar()
                share, add = '', ''
