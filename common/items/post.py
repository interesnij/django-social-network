...
def post(user, value):
    try:
        ...
        if post.community:
            ...
            class="load_post_comments btn_default" style="cursor:pointer;margin-right: 5px;', comments_enabled, '"><svg viewBox="0 0 24 24" class="svg_info" fill="currentColor"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"></path></svg><span class="comment-count">', str(post.count_comments()), '</span></span>\
