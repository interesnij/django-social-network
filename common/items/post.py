...
def get_post(user, value):
    try:
        ...
        if post.community:
            ...
            return ''.join([block, '<span class="card mb-3" data-pk="', str(community.pk), '"list-pk="', str(post.get_list_pk()), '" data-uuid="', str(post.uuid), '"><div class="card-header">\
            ...
            if post.creator.pk == user.pk:
                ...
                card_drop = '<span class="dropdown-item post_claim">Пожаловаться</span>'
            return ''.join([block, '<span class="card mb-3" data-pk="', str(creator.pk), '"list-pk="', str(post.get_list_pk()), '" data-uuid="', str(post.uuid), '"><div class="card-header">\
