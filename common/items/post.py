...
def get_post(user, value):
    ...
    try:
        ...
        if post.is_have_likes():
            ...
            window_likes = 'Оценили: ' + post.likes_count_ru() + '</span><span style="display: flex;margin-top: 10px;">'
        ...
        if post.is_have_dislikes():
            ...
            window_dislikes = 'Оценили: ' + post.dislikes_count_ru() + '</span><span style="display: flex;margin-top: 10px;">'
        ...
        if post.community:
            ...
            </svg><span class="likes_count" data-count="like">', str(post.likes_count()), '</span></span><span class="like_window"><div class="like_pop"><span class="c_all_posts_likes pointer">', window_likes, '</span><span ', votes_on, ' class="dislike \
            ...
            </svg><span class="dislikes_count">', str(post.dislikes_count()), '</span></span><span class="dislike_window"><div class="like_pop"><span class="c_all_posts_likes pointer">', window_dislikes, '</span><span title="Комментарий" \
