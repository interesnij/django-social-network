...
def get_template_community_doc(playlist, folder, template, request_user, user_agent):
...
def get_template_user_doc(playlist, folder, template, request_user, user_agent):
