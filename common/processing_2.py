        ...
        for word in words:
            ...
            if "#" in word:
                ...
                if word[0] == "#":
                    _p = word.strip(".,:;!_*-+()/@#¤%&)")
                    tag = "#" + _p
                    _loop[next] = _loop[this].replace(indent + word, ' <a class="ajax action" href="/search/?tag=' + _p + '">' + tag + '</a>')
                else:
                    _p = word.strip(".,:;!_*-+()/@#¤%&)")
                    p_2 = _p[_p.find("#") + 1:]
                    tag = "#" + p_2
            ...
            if word[0] == "@":
                ...
                if exists:
                    ...
                    next += 1
                    p_2 = "@" + _p
                    _loop[next] = _loop[this].replace(indent + word, ' <a class="action ajax show_mention_info pointer" href="/' + _p + '/">' + name + '</a>')
                ...
                if "." in _p and not ".png" in _p:
                    ...
                    if "трезвый.рус" in _p:
                        ...
                        this += 1
                        next += 1
                        _loop[next] = _loop[this].replace(indent + _p, ' <a class="ajax action" href="' + p_2 + '">' + _p + '</a>')
                    else:
                        p_items = _p.split(".")
                        p_zone = "." + p_items[-1]
                        ...
                        for zone in zons:
                            if zone == p_zone:
                                ...
                                this += 1
                                next += 1
                                _loop[next] = _loop[this].replace(indent + _p, ' <a class="action" target="_blank" href="' + p_2 + '">' + _p + '</a>')
                                break
                    _exlude.append(_p)
