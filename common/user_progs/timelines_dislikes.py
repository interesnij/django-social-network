...
def get_timeline_post_dislikes(user_pk):
    ...
    own_posts_query = Q(id__in=[post['parent_id'] for post in dislikes], is_deleted=False, status=Post.STATUS_PUBLISHED)
...
def get_timeline_photo_dislikes(user_pk):
    ...
    own_photos_query = Q(id__in=[photo['parent_id'] for photo in dislikes], is_deleted=False, is_public=True)
...
def get_timeline_good_dislikes(user_pk):
    ...
    own_goods_query = Q(id__in=[good['parent_id'] for good in dislikes], is_deleted=False, status=Good.STATUS_PUBLISHED)
...
def get_timeline_video_dislikes(user_pk):
    ...
    own_videos_query = Q(id__in=[video['parent_id'] for video in dislikes], is_deleted=False, is_public=True)
...
def get_timeline_featured_post_dislikes(user):
    ...
    own_posts_query = Q(id__in=[post['parent_id'] for post in dislikes], is_deleted=False, status="P")
...
def get_timeline_featured_good_dislikes(user):
    ...
    own_goods_query = Q(id__in=[good['parent_id'] for good in dislikes], is_deleted=False, status="P")
