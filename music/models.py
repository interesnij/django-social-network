...
class SoundcloudParsing(models.Model):
    ...
    item = models.ManyToManyField("main.Item", blank=True, related_name='item_music')
    item_comment = models.ManyToManyField("main.ItemComment", blank=True, related_name='comment_music')
