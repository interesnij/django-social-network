...
class CommunityMemberPerm(models.Model):
    ...
    can_see_survey = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто видит опросы")
    ...
    can_add_post = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто копирует записи и списки")
    can_add_photo = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто копирует фото и списки")
    can_add_good = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто копирует товары и списки")
    can_add_video = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто копирует видео и списки")
    can_add_planner = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто копирует рабочие пространства и доски")
    can_add_doc = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто копирует документы и списки")
    can_add_music = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто копирует музыку и списки")

    can_create_post = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто создает записи, работает с ними")
    can_create_photo = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто создает фото, работает с ними")
    can_create_good = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто создает товары, работает с ними")
    can_create_video = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто создает видео, работает с ними")
    can_create_planner = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто создает доски, работает с ними")
    can_create_doc = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто создает документы, работает с ними")
    can_create_music = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто создает музыку, работает с ними")
    can_create_survey = models.PositiveSmallIntegerField(choices=ITEM, default=0, verbose_name="Кто создает опросы, работает с ними")
