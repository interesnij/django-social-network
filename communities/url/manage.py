...
urlpatterns = [
    ...
    url(r'^notify_music/(?P<pk>[0-9]+)/$', CommunityMusicVideoView.as_view(), name='community_music_notify'),
    ...
    url(r'^private_music/(?P<pk>[0-9]+)/$', CommunityMusicVideoView.as_view(), name='community_music_private'),
