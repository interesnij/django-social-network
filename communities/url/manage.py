...
urlpatterns = [
    ...
    url(r'^notify_post/(?P<pk>[0-9]+)/$', login_required(CommunityNotifyPostView.as_view()), name='community_post_notify'),
    url(r'^private_post/(?P<pk>[0-9]+)/$', login_required(CommunityPrivatePostView.as_view()), name='community_post_private'),
