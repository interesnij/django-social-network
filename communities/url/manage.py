...
urlpatterns = [
    ...
    url(r'^(?P<pk>[0-9]+)/notify_post/$', login_required(CommunityNotifyPostView.as_view()), name='community_post_notify'),
    url(r'^(?P<pk>[0-9]+)/private_post/$', login_required(CommunityPrivatePostView.as_view()), name='community_post_private'),
