...
class CommunitySectionsOpen(models.Model):
    ...
    can_see_planner_workspace = models.CharField(max_length=3, choices=PERM_PLANNER, default=MEMBERS, verbose_name="Кто видит рабочие пространства и весь раздел планирования")
    can_see_planner_board = models.CharField(max_length=3, choices=PERM_PLANNER, default=MEMBERS, verbose_name="Кто видит доски планирования")
    can_see_planner_column = models.CharField(max_length=3, choices=PERM_PLANNER, default=MEMBERS, verbose_name="Кто видит колонки досок планирования")
