    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_adjective', models.CharField(blank=True, max_length=100, null=True, verbose_name='Какой-то пользователь')),
                ('users_adjective', models.CharField(blank=True, max_length=100, null=True, verbose_name='Какие-то пользователи')),
                ...
                ('starrers', models.ManyToManyField(blank=True, related_name='favorite_communities', to=settings.AUTH_USER_MODEL, verbose_name='Подписчики')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='communities_memberships', to=settings.AUTH_USER_MODEL, verbose_name='Члены сообщества')),
            ],
        ),
        migrations.CreateModel(
            name='CommunityLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_communities_invites', to=settings.AUTH_USER_MODEL, verbose_name='Кто приглашает в сообщество')),
                ('invited_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='communities_invites', to=settings.AUTH_USER_MODEL, verbose_name='Кого приглашают в сообщество')),
            ],
        ),
    ]
