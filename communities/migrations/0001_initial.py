# Generated by Django 2.2.5 on 2019-11-01 14:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', imagekit.models.fields.ProcessedImageField(null=True, upload_to=communities.helpers.upload_to_community_avatar_directory)),
                ...
                ('type', models.CharField(choices=[('P', 'Публичное'), ('T', 'Приватное')], default='P', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('community', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='top_posts_community_exclusions', to='communities.Community')),
