...
(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (a) {
          var onclick_start = '$("#name-of-the-song-that-plays").html($(this).html().substr(0,65))';
            var c = this,

                d = "<li class='track_item_li'><div>",
                d = d + ("<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>");
                if (a.artwork_url){
                  d = d + '<a href="javascript:;" onclick="$("#name-of-the-song-that-plays").html($(this).html().substr(0,65))" ><img class="track_img" src=' + a.artwork_url + ' /></a>'
                }else{
