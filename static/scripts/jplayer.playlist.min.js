...
(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (a) {
            ...
            d += "<a href='javascript:;' onclick='$(" + '"#name-of-the-song-that-plays"' +").html($(this).html().substr(0,65))' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + "</a><br>";
            d += "<a href='' class='discription'>" + a.genre + "</a>"
            d += "<a href='' class='music_add'>" + 'плюс' + "</a>"
            d += "<a href='' class='music_repost'>" + 'репост' + "</a>"
            return d += "</div></li>"
        },
