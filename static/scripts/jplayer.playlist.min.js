(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _highlight: function (a) {
            ...
            $('.tracks-container .ul_track_list').find(".jp-playlist-current").removeClass("jp-playlist-current"),
            $('.tracks-container .ul_track_list').find(".id_" + this.playlist[a].pk).addClass("jp-playlist-current")
          )
        },
