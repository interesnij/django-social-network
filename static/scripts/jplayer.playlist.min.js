(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _highlight: function (a) {
            ...
            $('.music_script_check ul').find(".jp-playlist-current").removeClass("jp-playlist-current"),
            $('.music_script_check ul').find(".id_" + this.playlist[a].pk).addClass("jp-playlist-current")
          )
        },
