(function (b, f) {
    jPlayerPlaylist = function (a, c, d) {
        ...
        this.options = b.extend(!0, {
            keyBindings: {
                next: {key: 39,fn: function () {e.next()}},
                previous: {key: 37,fn: function () {e.previous()}} }
        }, this._options, d);
        this.playlist = [];
        this.original = [];
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (a) {
            ...
            if(!a.is_my_track){
              track_move = "<span class='track_add' title='Добавить'><svg fill='currentColor' class='svg_default' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z'/><path d='M0 0h24v24H0z' fill='none'/></svg></span>"
            }else{
              track_move = "<span class='track_remove' title='Удалить'><svg xmlns='http://www.w3.org/2000/svg' fill='currentColor' style='width:20px;' class='svg_default' viewBox='0 0 24 24'><path fill='none' d='M0 0h24v24H0z'/><path d='M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z'/></svg></span>"
            };
            ...
            d += "<span data-pk=" + a.pk + " class='span_btn'><span>" + track_move + "</span>&nbsp;<span class='track_repost'><svg class='svg_default' fill='currentColor' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M0 0h24v24H0z' fill='none'/><path d='M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z'/></svg></span></span>"
            return d += "</div></li>"
        },
        ...
        _highlight: function (a) {
            ...
            b(this.cssSelector.title + " li").html(this.playlist[a].title),
            $('#ajax.ul_track_list.jp-playlist-current').removeClass("jp-playlist-current"),
            element = "$('" + "#ajax.ul_track_list li:nth-child(" + (a + 1) + ")" + "')",
            "$('" + "#ajax.ul_track_list li:nth-child(" + (a + 1) + ")').addClass("jp-playlist-current")
          )
        },
