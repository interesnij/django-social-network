...
(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (a) {
            var c = this,
                d = "<li style='white-space:nowrap;overflow:hidden;'><div>",
                d = d + ("<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>");
                if (a.artwork_url){
                  d = d + '<img style="width:55px;padding-left:7px;" src=' + a.artwork_url + ' />'
                }else{
                  d = d + '<svg class="svg_default" fill="currentColor" style="width:55px;padding-left:7px;heigth:auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"/></svg>'
                }
                d = d + ("<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>");
            if (a.free) {
                var e = !0,
            ...
            var name = a.title;
              name = '<strong style="left:10px;bottom:10px;position:relative;">' + a.title + '</strong>';
            ...
            d += "<a href='' style='bottom:17px;position:relative;padding-left:55px;'>" + a.genre + "</a>&nbsp;&nbsp;&nbsp;"
            d += "<span style='float:right;position:relative;padding-right:10px;bottom:17px;'><a href='' class='music_add'>плюс</a>&nbsp;<a href='' class='music_repost'>" + 'репост' + "</a></span>"
            return d += "</div></li>"
        },
