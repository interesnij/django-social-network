    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (a) {
            var c = this,
                ...
                if (a.artwork_url){
                  onclick_start = "$('#name-of-the-song-that-plays').html($(this).html().substr(0,65))"
                  class_start = "class='" + this.options.playlistOptions.itemClass + "' tabindex='1'";
                  d = d + '<a href="javascript:;" onclick="$('#name-of-the-song-that-plays').html($(this).html().substr(0,65))" class_start><img class="track_img" src=' + a.artwork_url + ' /></a>'
                }else{
