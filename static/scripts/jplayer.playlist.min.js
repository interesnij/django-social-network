(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _init: function () {
            ...
            $('.jp-playlist .track_item_li.track_img').click(function() {
              img=$(this); title=img.next();
               $('#name-of-the-song-that-plays').html(title.html().substr(0,65));
            });
        },
        ...
        _createListItem: function (a) {
          var name = a.title;
            var c = this,
                ...
                if (a.artwork_url){
                  d = d + "<a href='javascript:;' onclick='$(" + '"#name-of-the-song-that-plays"' + ").html($(this).next().next().html().substr(0,65))' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + "<img class='track_img' src=" + a.artwork_url + " />" + "</a>"
                }else{
                  d = d + "<a href='javascript:;' onclick='$(" + '"#name-of-the-song-that-plays"' +").html($(this).html().substr(0,65))' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + "<svg class='svg_default track_img' fill='currentColor' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path fill='none' d='M0 0h24v24H0z'/><path d='M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z'/></svg>"
                }
                d = d + ("<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>");
            if (a.free) {
                var e = !0,
