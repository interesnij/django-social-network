    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (a) {
            var c = this,
                ...
                if (a.artwork_url){
                  d = d + '<img style="width:30px;heigth:auto" src=' + a.artwork_url + ' />'
                }else{
                  d = d + '<svg class="svg_default" fill="currentColor" style="width:30px;heigth:auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"/></svg>'
                }
                d = d + ("<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>");
            if (a.free) {
                var e = !0,
