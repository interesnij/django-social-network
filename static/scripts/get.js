...
$('#ajax').on('click', '.u_good_detail', function() {good = $(this);good_id = good.data("id"); user_uuid = good.parent().data("uuid");$('#good_loader').html('').load("/goods/user/good/" + good_id + "/" + user_uuid + "/");$('.good_fullscreen').show();console.log("user good open")});
