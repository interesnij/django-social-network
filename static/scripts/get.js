...
on('body', 'click', '.video_fullscreen_hide', function() {get_normal_screen(); document.querySelector(".video_fullscreen").style.display = "none";document.getElementById("video_loader").innerHTML=""});
