...
on('body', 'click', '.video_fullscreen_hide', function() {document.querySelector(".video_fullscreen").style.display = "none";get_normal_screen();document.getElementById("video_loader").innerHTML=""});
