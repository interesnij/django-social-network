...
on('#ajax', 'click', '#article_add', function() {
  ...
  document.body.append('<script type="text/javascript" src="{% static "ckeditor/ckeditor-init.js" %}"></script><script type="text/javascript" src="{% static "ckeditor/ckeditor/ckeditor.js" %}"></script>')
});
