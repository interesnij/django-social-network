...
on('#ajax', 'click', '.photo_load_one', function() {
  ...
  if (document.body.querySelector(".current_file_dropdown")){
    ...
    check_photo_in_block(document.body.querySelector(".attach_block"), _this.parentElement, pk) ? null : (photo_post_attach(_this, document.body.querySelector(".attach_block"), pk), close_create_window())
  } else if (document.body.querySelector(".message_attach_block")){
