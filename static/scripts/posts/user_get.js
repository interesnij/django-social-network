...
on('#ajax', 'click', '.fullscreen', function() {
  ...
  this.parentElement.parentElement.parentElement.parentElement.parentElement.getAttribute('data-pk') ? (tab_container = this.parentElement.parentElement.parentElement.previousElementSibling, console.log(tab_container), pk = tab_container.querySelector(".tab_active").getAttribute('list-pk')) : pk = this.parentElement.getAttribute('list-pk');
