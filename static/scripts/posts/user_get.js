...
on('#ajax', 'click', '.fullscreen', function() {
  ...
  this.parentElement.parentElement.parentElement.parentElement.parentElement.getAttribute('data-pk') ? pk = this.parentElement.parentElement.parentElement.previousElementSibling.querySelector(".tab_active").getAttribute('list-pk') : pk = this.parentElement.getAttribute('list-pk');
