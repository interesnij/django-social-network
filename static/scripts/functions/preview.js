...
function create_preview_commmunity(_this, pk){
  ...
  _this.querySelector("img") ? ($img = document.createElement("img"), $img.setAttribute("data-src", img_src),$img.style.width = "50px",$img.style.heigth = "auto",$img.style.borderRadius = "50%")
...
function create_preview_chat_item(_this, pk){
  $div = document.createElement("div");
  $div.style.paddingTop = "5px";
  $div.style.paddingBottom = "5px";
  $div.setAttribute("data-pk", pk);
  ...
  _this.querySelector("img") ? ($img = document.createElement("img"), $img.setAttribute("data-src", img_src),$img.style.width = "30px",$img.style.heigth = "auto",$img.style.borderRadius = "50%")
