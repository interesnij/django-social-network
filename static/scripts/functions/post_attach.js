...
function photo_post_attach(_this, block) {
  ...
  pk = _this.getAttribute('photo-uuid');
    if (!block.querySelector(".photo_input")){div = create_preview_photo("select_photo1", _this.getAttribute('data-href'), pk);}
    else if (!block.querySelector(".select_photo2")){div = create_preview_photo("select_photo2", _this.getAttribute('data-href'), pk);}
    else if (!block.querySelector(".select_photo3")){div = create_preview_photo("select_photo3", _this.getAttribute('data-href'), pk);}
    else if (!block.querySelector(".select_photo4")){div = create_preview_photo("select_photo4", _this.getAttribute('data-href'), pk)}
    else if (!block.querySelector(".select_photo5")){div = create_preview_photo("select_photo5", _this.getAttribute('data-href'), pk)}
    else if (!block.querySelector(".select_photo6")){div = create_preview_photo("select_photo6", _this.getAttribute('data-href'), pk)}
    else if (!block.querySelector(".select_photo7")){div = create_preview_photo("select_photo7", _this.getAttribute('data-href'), pk)}
    else if (!block.querySelector(".select_photo8")){div = create_preview_photo("select_photo8", _this.getAttribute('data-href'), pk)}
    else if (!block.querySelector(".select_photo9")){div = create_preview_photo("select_photo9", _this.getAttribute('data-href'), pk)}
    else if (!block.querySelector(".select_photo10")){div = create_preview_photo("select_photo10", _this.getAttribute('data-href'), pk)}
    block.append(div);
