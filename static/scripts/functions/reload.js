...
function create_pagination(block){
	...
	if(block.querySelector('.profile_block_paginate')){
		...
		else if(block.querySelector('#community_editors_container')){com_editors = block.querySelector('#community_editors_container'); scrolled(com_editors, com_editors.getAttribute("data-link"), '#community_editors_container')}
		else if(block.querySelector('#community_follows_container')){com_follows = block.querySelector('#community_follows_container'); scrolled(com_follows, com_follows.getAttribute("data-link"), '#community_follows_container')}
