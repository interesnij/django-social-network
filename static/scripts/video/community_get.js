...
on('#ajax', 'click', '.c_video_list_detail', function() {
  ...
  this.parentElement.parentElement.parentElement.parentElement.getAttribute ? uuid = this.parentElement.parentElement.parentElement.parentElement.getAttribute("data-uuid") : uuid = document.body.querySelector(".pk_saver").getAttribute("data-uuid");
