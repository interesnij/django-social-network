...
function show_chat_console(message) {
  ...
  if (list_not_have_favourite_messages) {
    ...
    favourite_btn.classList.replace("create_favourite_messages", "remove_favourite_messages")
  } else {
    ...
    favourite_btn.classList.replace("remove_favourite_messages", "create_favourite_messages")
  };
