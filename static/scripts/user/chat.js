...
function show_chat_console(message) {
  ...
  if (list_not_have_favourite_messages) {
    ...
    favourite_btn.classList.add("remove_favourite_messages").remove("create_favourite_messages")
  } else {
    ...
    favourite_btn.classList.remove("remove_favourite_messages").add("create_favourite_messages")
  };
