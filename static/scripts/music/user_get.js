...
on('#ajax', 'click', '.u_playlist_add', function() {
  ...
  create_fullscreen("/music/user_progs/add_list/" + pk + "/", "item_fullscreen");
});

on('#ajax', 'click', '.u_soundcloud_set_create', function() {
  create_fullscreen("/music/user_progs/souncloud_create_list_window/", "item_fullscreen");
});

on('#ajax', 'click', '.u_soundcloud_set_list', function() {
  create_fullscreen("/music/user_progs/souncloud_list_window/" + this.parentElement.parentElement.getAttribute('data-uuid') + "/", "item_fullscreen");
});
on('#ajax', 'click', '.u_music_list_create_window', function() {
  create_fullscreen("/music/user_progs/create_list_window/", "item_fullscreen");
});
on('#ajax', 'click', '.u_playlist_edit', function() {
  uuid = this.parentElement.parentElement.getAttribute('data-uuid');
  create_fullscreen("/music/user_progs/edit_list/" + uuid + "/", "item_fullscreen");
});
...
on('#ajax', 'click', '.u_ucm_music_repost', function() {
  ...
  create_fullscreen("/music/repost/u_ucm_music_window/" + pk + "/" + track_pk + "/", "item_fullscreen");
  clear_attach_block();
})
on('#ajax', 'click', '.u_ucm_music_list_repost', function() {
  ...
  create_fullscreen("/music/repost/u_ucm_list_window/" + pk + "/" + uuid + "/", "item_fullscreen");
  clear_attach_block();
})

on('#ajax', 'click', '.u_track_add', function() {
  pk = document.body.querySelector(".pk_saver").getAttribute("data-pk");
  create_fullscreen("/music/user_progs/add_track/" + pk + "/", "item_fullscreen");
});
