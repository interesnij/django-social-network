...
on('#ajax', 'click', '.u_add_track_in_list', function() {
  add_item_in_list(this, '/music/user_progs/u_add_track_in_list/', ".u_add_track_in_list", "u_remove_track_from_list")
})
on('#ajax', 'click', '.u_remove_track_from_list', function() {
  remove_item_from_list(this, '/music/user_progs/u_remove_track_from_list/', ".u_remove_track_from_list", "u_add_track_in_list")
})
