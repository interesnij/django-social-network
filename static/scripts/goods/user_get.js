...
on('#ajax', 'click', '.u_ucm_good_repost', function() {
  ...
  create_fullscreen("/goods/repost/u_ucm_good_window/" + pk + "/" + good_pk + "/", "item_fullscreen");
  clear_attach_block();
})
on('#ajax', 'click', '.u_ucm_good_list_repost', function() {
  ...
  create_fullscreen("/goods/repost/u_ucm_list_window/" + pk + "/" + uuid + "/", "item_fullscreen");
  clear_attach_block();
})

on('#ajax', 'click', '.u_good_list_add', function() {
  create_fullscreen("/goods/user_progs/add_list/" + document.body.querySelector(".pk_saver").getAttribute("data-pk") + "/", "item_fullscreen");
});
on('#ajax', 'click', '.u_good_list_edit', function() {
  uuid = this.parentElement.parentElement.getAttribute('data-uuid');
  create_fullscreen("/goods/user_progs/edit_list/" + uuid + "/", "item_fullscreen");
});

on('#ajax', 'click', '.u_goods_list_create', function() {
  pk = document.body.querySelector(".pk_saver").getAttribute("data-pk");
  create_fullscreen("/goods/user_progs/add_list/" + pk + "/", "item_fullscreen");
});
on('#ajax', 'click', '.u_all_good_likes', function() {
  ...
  create_fullscreen("/goods/window/all_user_like/" + pk + "/", "item_fullscreen");
});
on('#ajax', 'click', '.u_all_good_dislikes', function() {
  pk = this.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.getAttribute('good-pk');
  create_fullscreen("/goods/window/all_user_dislike/" + pk + "/", "item_fullscreen");
});

on('#ajax', 'click', '.u_all_good_comment_likes', function() {
  container = this.parentElement.parentElement.parentElement;
  pk = container.getAttribute('data-pk');
  create_fullscreen("/goods/window/all_user_comment_like/" + pk + "/", "item_fullscreen");
});
on('#ajax', 'click', '.u_all_good_comment_dislikes', function() {
  container = this.parentElement.parentElement.parentElement;
  pk = container.getAttribute('data-pk');
  create_fullscreen("/goods/window/all_user_comment_dislike/" + pk + "/", "item_fullscreen");
});

on('#ajax', 'click', '.u_all_good_reposts', function() {
  pk = this.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.getAttribute('good-pk');
  create_fullscreen("/goods/window/all_user_reposts/" + uuid + "/", "item_fullscreen");
});
