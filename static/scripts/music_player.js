              ...
              this.audioScreenPlayHandler = function() {
                ...
                (FWDMSP.keyboardCurInstance = self).controller_do && (self.controller_do.showPauseButton(), self.controller_do.startEqulizer()), self.opener_do && self.opener_do.showPauseButton(), self.playlist_do && self.playlist_do.setCurItemPauseState(), self.largePlayButton_do && self.largePlayButton_do.hide(), self.hider && self.hider.start(), self.openInPopup_bl && setTimeout(function() {
								...
								this.videosHolder_do = new FWDMSPDisplayObject("div"),
									...
									this.setupClickScreen(), this.setupDisableClick(), this.addDoubleClickSupport(), FWDMSPSimpleButton.setPrototype(), -1 != this.skinPath_str.indexOf("hex_white") ? self.largePlayButton_do = new FWDMSPSimpleButton(self.data.largePlayN_img, self.data.largePlayS_str, void 0, !0, self.data.useHEXColorsForSkin_bl, self.data.normalButtonsColor_str, "#FFFFFF") : self.largePlayButton_do = new FWDMSPSimpleButton(self.data.largePlayN_img, self.data.largePlayS_str, void 0, !0, self.data.useHEXColorsForSkin_bl, self.data.normalButtonsColor_str, self.data.selectedButtonsColor_str, FWDMSPComplexButton.setPrototype(), self.data.normalButtonsColor_str, self.data.selectedButtonsColor_str)
