	...
	function(window) {
		var FWDMSPAudioData = function(props, playListElement, parent) {
			...
			self.parseProperties = function() {
					if (this.useYoutube_bl = self.props_obj.useYoutube || "no",
					    this.useYoutube_bl = "yes" == self.useYoutube_bl,
							this.addKeyboardSupport_bl = self.props_obj.addKeyboardSupport || "no",
								...
								if (self.skinPath_str.lastIndexOf("/") + 1 != self.skinPath_str.length && (self.skinPath_str += "/"),
									...
									if (self.totalCats = e.length,
										 ...
										 for (var t = 0; t < self.totalCats; t++) {
											...
											o.playlistsName = FWDMSPUtils.getAttributeValue(child, "data-playlist-name"),
											o.source = FWDMSPUtils.getAttributeValue(child, "data-source"),
											o.thumbnailPath = FWDMSPUtils.getAttributeValue(child, "data-thumbnail-path"),
											o.htmlContent = child.innerHTML, o.htmlText_str = child.innerText,
											self.cats_ar[t] = o
										}
										...
										isNaN(self.volume) && (volume = 1),
										1 < self.volume ? self.volume = 1 : self.volume < 0 && (self.volume = 0),
