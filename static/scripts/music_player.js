            ...
            this.instanceName_str)
            {
						...
						if (self.init = function() {
								...
								if (self.ws || (self.ws = FWDMSPUtils.getViewportSize()), self.controller_do && self.allowToResizeAndPosition_bl) {
									if (self.openInPopup_bl) return self.main_do.setX(0),
										...
										self.controller_do.setY(0), void(self.playlist_do && (FWDAnimation.killTweensOf(self.playlist_do), self.playlist_do.setX(0), self.playlist_do.setY(self.controller_do.h)));
									clearTimeout(self.showPlaylistWithDelayId_to), self.playlist_do && self.playlist_do.isShowed_bl && (addToHeight = self.playlist_do.h), self.position_str == FWDMSP.POSITION_TOP ? self.playlist_do ? (self.background_do && self.background_do.setHeight(self.playlist_do.h + self.controller_do.h), self.playlist_do.setY(0), self.controller_do.setY(self.playlist_do.h), self.main_do.setHeight(self.playlist_do.h + self.controller_do.h)) : (self.background_do && self.background_do.setHeight(self.controller_do.h), self.controller_do.setY(0), self.main_do.setHeight(self.controller_do.h)) : self.playlist_do ? (self.background_do && self.background_do.setHeight(self.playlist_do.h + self.controller_do.h + 150), self.playlist_do.setY(self.controller_do.h), self.controller_do.setY(0), self.main_do.setHeight(self.playlist_do.h + self.controller_do.h)) : (self.background_do && self.background_do.setHeight(self.controller_do.h), self.controller_do.setY(0), self.main_do.setHeight(self.controller_do.h)),
								...
								self.main_do.setX(0), self.background_do && (self.background_do.getStyle().width = "100%")
              ...
              this.audioScreenPlayHandler = function() {
                ...
                (FWDMSP.keyboardCurInstance = self).controller_do && (self.controller_do.showPauseButton(), self.controller_do.startEqulizer()), self.opener_do && self.opener_do.showPauseButton(), self.playlist_do && self.playlist_do.setCurItemPauseState(), self.largePlayButton_do && self.largePlayButton_do.hide(), self.hider && self.hider.start(), self.openInPopup_bl && setTimeout(function() {
								...
								self.isPlaying_bl = !1, self.opener_do && self.opener_do.showPlayButton(), self.largePlayButton_do && self.largePlayButton_do.show(), self.hider && (self.hider.reset(), self.hider.stop()), !FWDMSPUtils.isIphone && self.largePlayButton_do && (self.isMobile_bl || self.largePlayButton_do && self.largePlayButton_do.show()),
								...
								FWDMSPUtils.isIEWebKit && (self.firstTapPlaying_bl = self.isPlaying_bl), e.touches && 1 != e.touches.length || (t = Math.abs(s.screenX - self.firstTapX), o = Math.abs(s.screenY - self.firstTapY), self.isMobile_bl && (10 < t || 10 < o) || !self.isMobile_bl && (2 < t || 2 < o) || (FWDMSPUtils.isIEWebKit || (self.firstTapPlaying_bl ? self.play() : self.pause())))
								...
								this.videosHolder_do = new FWDMSPDisplayObject("div"),
									...
									this.setupClickScreen(), this.setupDisableClick(), this.addDoubleClickSupport(), FWDMSPSimpleButton.setPrototype(), -1 != this.skinPath_str.indexOf("hex_white") ? self.largePlayButton_do = new FWDMSPSimpleButton(self.data.largePlayN_img, self.data.largePlayS_str, void 0, !0, self.data.useHEXColorsForSkin_bl, self.data.normalButtonsColor_str, "#FFFFFF") : self.largePlayButton_do = new FWDMSPSimpleButton(self.data.largePlayN_img, self.data.largePlayS_str, void 0, !0, self.data.useHEXColorsForSkin_bl, self.data.normalButtonsColor_str, self.data.selectedButtonsColor_str), self.largePlayButton_do.addListener(FWDMSPSimpleButton.MOUSE_UP, self.largePlayButtonUpHandler), FWDMSPComplexButton.setPrototype(), self.data.normalButtonsColor_str, self.data.selectedButtonsColor_str)
