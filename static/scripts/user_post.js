...
on('#ajax', 'click', '.u_dislike2', function() {
  ...
  vote_reload("/item_window/u_comment_like_window/" + comment_pk + "/" + pk + "/", "/item_window/u_comment_dislike_window/" + comment_pk + "/" + pk + "/", this.previousElementSibling, this.nextElementSibling)
});
