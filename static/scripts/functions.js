...
function is_full_attach(){
  ...
  if (!files_block.classList.contains("files_10")){
    files_block.style.display = "-webkit-box"}
}
...
function music_post_attach(_this, block) {
  ...
  pk = _this.getAttribute('data-pk');
    ...
    else if (block.querySelector(".select_music1")){div = create_preview_music("select_music2", _this.getAttribute('data-src'), pk, counter)}
    else if (block.querySelector(".select_music2")){div = create_preview_music("select_music3", _this.getAttribute('data-src'), pk, counter)}
    else if (block.querySelector(".select_music3")){div = create_preview_music("select_music4", _this.getAttribute('data-src'), pk, counter)}
    else if (block.querySelector(".select_music4")){div = create_preview_music("select_music5", _this.getAttribute('data-src'), pk, counter)}
    else if (block.querySelector(".select_music5")){div = create_preview_music("select_music6", _this.getAttribute('data-src'), pk, counter)}
    else if (block.querySelector(".select_music6")){div = create_preview_music("select_music7", _this.getAttribute('data-src'), pk, counter)}
    else if (block.querySelector(".select_music7")){div = create_preview_music("select_music8", _this.getAttribute('data-src'), pk, counter)}
    else if (block.querySelector(".select_music8")){div = create_preview_music("select_music9", _this.getAttribute('data-src'), pk, counter)}
    else if (block.querySelector(".select_music9")){div = create_preview_music("select_music10", _this.getAttribute('data-src'), pk, counter)}
  block.append(div);
