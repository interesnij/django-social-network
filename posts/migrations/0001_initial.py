    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('D', 'Черновик'), ('PG', 'Обработка'), ('P', 'Опубликована'), ('MP', 'Репост в сообщения'), ('A', 'Архивирована'), ('C', 'Репост фотографии'), ('PAR', 'Репост фотоальбома'), ('GR', 'Репост товара'), ('GLR', 'Репост списка товаров'), ('MR', 'Репост аудиозаписи'), ('MLR', 'Репост плейлиста аудиозаписей'), ('DR', 'Репост документа'), ('DLR', 'Репост списка документов'), ('VR', 'Репост видеозаписи'), ('VLR', 'Репост списка видеозаписей'), ('UR', 'Репост пользователя'), ('CR', 'Репост сообщества')], default='P', max_length=5, verbose_name='Статус статьи')),
