                ...
                try:
                    ...
                    if user.is_authenticated:
                        ...
                        if playlist.is_user_can_add_list(user.pk):
                            add_svg = '<span title="Добавить плейлист" class="u_add_music_list"><svg fill="currentColor" class="svg_default pointer" style="margin-top: 14px;width:25px" viewBox="0 0 24 24"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/><path d="M0 0h24v24H0z" fill="none"/></svg></span>'
                        elif user.pk in playlist.get_users_ids():
                            add_svg = '<span title="Удалить плейлист" class="u_remove_music_list"><svg fill="currentColor" class="svg_default pointer" style="margin-top: 14px;width:25px" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z"/><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"/></svg></span>'
