            ...
            if item[:3] == "pho":
                ...
                try:
                    ...
                    for answer in survey.get_answers():
                        answers = ''.join([answers, '<div class="custom_color answer_style', _class, '" style="display:flex"><div class="progress2" style="width:', str(answer.get_procent()), '%;"></div><span class="progress_span_r">', answer.text, '</span><span class="progress_span_l" style="margin-left: auto;">', str(answer.get_count())])
