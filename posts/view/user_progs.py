    ...
    def post(self,request,*args,**kwargs):
        ...
        if request.is_ajax() and form_post.is_valid():
            ...
            if request.POST.get('text') or request.POST.get('attach_items'):
                ...
                return render_for_platform(request, 'posts/post_user/new_post.html', {'object': new_post, 'item1': request.POST.getlist('attach_items')[2:], 'item2': request.POST.getlist('attach_items')[3:]})
            else:
