        ...
        if request.is_ajax() and form_post.is_valid():
            ...
            for object_id in connections:
                ...
                if object_id[0] == "c":
                    ...
                    message = Message.send_message(chat=chat, creator=request.user, repost=new_post, parent=None, text="Репост записи пользователя", attach=attach, voice=None, sticker=None)
                elif object_id[0] == "u":
