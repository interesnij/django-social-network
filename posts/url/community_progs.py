...
urlpatterns = [
	...
	url(r'^restore_comment/(?P<pk>\d+)/(?P<comment_pk>\d+)/$', PostCommentCommunityAbortDelete.as_view()),
	url(r'^delete_wall_comment/(?P<pk>\d+)/(?P<comment_pk>\d+)/$', PostWallCommentCommunityDelete.as_view()),
	url(r'^restore_wall_comment/(?P<pk>\d+)/(?P<comment_pk>\d+)/$', PostWallCommentCommunityAbortDelete.as_view()),
	...
	url(r'^restore/(?P<pk>\d+)/(?P<uuid>[0-9a-f-]+)/$', PostCommunityAbortDelete.as_view()),
	url(r'^wall_restore/(?P<pk>\d+)/(?P<uuid>[0-9a-f-]+)/$', PostWallCommunityAbortDelete.as_view()),
    ...
    url(r'^restore_list/(?P<pk>\d+)/(?P<list_pk>\d+)/$', CommunityPostListAbortDelete.as_view()),
