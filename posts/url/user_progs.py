...
urlpatterns = [
	...
	url(r'^abort_delete_comment/(?P<pk>\d+)/$', PostCommentUserAbortDelete.as_view()),
	url(r'^delete_wall_comment/(?P<pk>\d+)/(?P<comment_pk>\d+)/$', PostWallCommentUserDelete.as_view()),
	url(r'^abort_delete_wall_comment/(?P<pk>\d+)/(?P<comment_pk>\d+)/$', PostWallCommentUserAbortDelete.as_view()),
