...
CONNECTION_REQUEST, WOMAN_CONNECTION_REQUEST, GROUP_CONNECTION_REQUEST = 'CRE', 'WCRE', 'GCRE'
#'принят в' друзья 'принят в' сообщество - универсальное
CONNECTION_CONFIRMED, WOMAN_CONNECTION_CONFIRMED, GROUP_CONNECTION_CONFIRMED = 'CCO', 'WCCO', 'GCCO'
#'рекомендует' друзей 'рекомендует' сообщество - универсальное
INVITE, INVITE, INVITE = 'INV', 'WINV', 'GINV'
COMMUNITY_JOIN, WOMAN_COMMUNITY_JOIN, GROUP_COMMUNITY_JOIN = 'CJO', 'WCJO', 'GCJO'

REGISTER, WOMAN_REGISTER, GROUP_REGISTER = 'REG', 'WREG', 'GREG'
