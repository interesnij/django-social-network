...
urlpatterns = [
    ...
    url(r'^u_article_window/(?P<pk>\d+)/$', login_required(ArticleCommunityWindow.as_view())),
    url(r'^c_article_window/(?P<pk>\d+)/$', login_required(ArticleUserWindow.as_view()), name="article_user_window"),
