...
urlpatterns = [
    ...
    url(r'^delete/(?P<pk>\d+)/$', ArticleDeleteView.as_view(), name='article_delete_post'),
    ...
    url(r'^get-comment/$', article_get_comment, name='article_get_comment'),
    url(r'^post-comment/$', article_post_comment, name='article_post_comments'),
