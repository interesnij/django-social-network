        ...
        if count == 2:
            ...
            if self.image:
                ...
                for figure in self.get_avatars():
                    if figure:
                        avatars += '<figure><img src="' + figure + '" style="border-radius:50px;width:50px;" class="avatar-50 staked" alt="image"></figure>'
                    else:
                        avatars += '<figure><img src="/static/images/no_img/user.jpg" style="border-radius:50px;width:50px;" class="avatar-50 staked" alt="image"></figure>'
            if self.name:
                 chat_name = self.name
            else:
                chat_name = "Групповой чат"
