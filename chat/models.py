...
class Message(models.Model):
    ...
    def get_parent_message(self):
        ...
        return '<div class="media p-1" data-uuid="' + str(parent.uuid) + '"><figure><a href="' + user.get_link() + '" class="ajax"><img src="' + user.get_avatar() + '" style="border-radius:30px;width:30px;" alt="image"></a></figure><div class="media-body"><p class="time-title mb-0"><a href="' + user.get_link()  + '" class="ajax">' + user.first_name + '</a></p><small class="float-right text-muted">' + parent.get_created() + '</small><p class="text">' + preview + '</p></div></div>'
