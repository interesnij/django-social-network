...
urlpatterns = [
	url(r'^user_like/(?P<photo_pk>\d+)/(?P<pk>\d+)/$',login_required(PhotoUserLikeCreate.as_view())),
    url(r'^user_dislike/(?P<photo_pk>\d+)/(?P<pk>\d+)/$',login_required(PhotoUserDislikeCreate.as_view())),
	...
	url(r'^community_like/(?P<photo_pk>\d+)/(?P<pk>\d+)/$',login_required(PhotoCommunityLikeCreate.as_view())),
    url(r'^community_dislike/(?P<photo_pk>\d+)/(?P<pk>\d+)/$',login_required(PhotoCommunityDislikeCreate.as_view())),
