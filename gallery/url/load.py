...
urlpatterns=[
    ...
    url(r'^community_album_photo/(?P<pk>\d+)/(?P<album_uuid>[0-9a-f-]+)/$', CommunityAlbumPhoto.as_view(), name="community_album_photo"),
    url(r'^community_wall/(?P<pk>\d+)/(?P<uuid>[0-9a-f-]+)/$', CommunityWallPhoto.as_view(), name="c_wall_photo"),
