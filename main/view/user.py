...
class ItemCommentUserCreate(View):
	...
	def post(self,request,*args,**kwargs):
		...
		if form_post.is_valid():
			...
			html = render_to_string('item_user/parent_comment.html',{'comment': new_comment, 'request_user': request.user, "form_comment": CommentForm(), "form_reply": CommentReplyForm(), 'request': request})
