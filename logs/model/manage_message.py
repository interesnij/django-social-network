...
class MessageManageLog(models.Model):
    ...
    item = models.PositiveIntegerField(default=0, verbose_name="Элемент сообщений")
...
class MessageWorkerManageLog(models.Model):
    CREATE_ADMIN = 'CA'
    DELETE_ADMIN = 'DA'
    CREATE_EDITOR = 'CE'
    DELETE_EDITOR = 'DE'
    ...
    DELETE_MODERATOR = 'DM'
    ACTION_TYPES = (
        (CREATE_ADMIN, 'Добавлен админ сообщений'),
        (DELETE_ADMIN, 'Удален админ сообщений'),
        (CREATE_EDITOR, 'Добавлен редактор сообщений'),
        (DELETE_EDITOR, 'Удален редактор сообщений'),
        (CREATE_MODERATOR, 'Добавлен модератор сообщений'),
        (DELETE_MODERATOR, 'Удален модератор сообщений'),
    )
    ...
    class Meta:
        indexes = (BrinIndex(fields=['created']),)
        verbose_name = "Лог суперменеджера сообщений"
        verbose_name_plural = "Логи суперменеджеров сообщений"
        ordering=["-created"]

class MessageCreateWorkerManageLog(models.Model):
    CREATE_ADMIN = 'CA'
    DELETE_ADMIN = 'DA'
    CREATE_EDITOR = 'CE'
    DELETE_EDITOR = 'DE'
    ...
    DELETE_MODERATOR = 'DM'
    ACTION_TYPES = (
        (CREATE_ADMIN, 'Добавлен создатель админов сообщений'),
        (DELETE_ADMIN, 'Удален создатель админов сообщений'),
        (CREATE_EDITOR, 'Добавлен создатель редакторов сообщений'),
        (DELETE_EDITOR, 'Удален создатель редакторов сообщений'),
        (CREATE_MODERATOR, 'Добавлен создатель модераторов сообщений'),
        (DELETE_MODERATOR, 'Удален создатель модераторов сообщений'),
    )
    ...
    class Meta:
        indexes = (BrinIndex(fields=['created']),)
        verbose_name = "Лог создателя суперменеджера сообщений"
        verbose_name_plural = "Логи создателей суперменеджеров сообщений"
        ordering=["-created"]
