...
class GoodUserCreate(TemplateView):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if self.form.is_valid():
            ...
            new_good = good.create_good(title=good.title, sub_category=good.sub_category, creator=self.user, description=good.description, community=None, price=good.price, comments_enabled=good.comments_enabled, votes_on=good.votes_on, status="PG")
