...
class Good(models.Model):
	...
	@classmethod
	def create_good(cls, title, community_id, image, albums, images, sub_category, creator, description, \
					price, comments_enabled, votes_on, status):
		good = Good.objects.create(title=title, image=image, community_id=community_id, sub_category=sub_category, creator=creator, description=description, \
