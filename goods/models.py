...
class Good(models.Model):
	...
	image = ProcessedImageField(verbose_name='Главное изображение', format='JPEG',options={'quality': 80}, processors=[ResizeToFit(width=512, upscale=False)],upload_to="goods/%Y/%m/%d")
