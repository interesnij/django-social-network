...
class UserPostNotifications(models.Model):
    ...
    user_mention = models.BooleanField(default=True, verbose_name="Упоминание в записи")
    comment_user_mention = models.BooleanField(default=True, verbose_name="Упоминание в комментарии к записи")
...
class UserPhotoNotifications(models.Model):
    ...
    user_mention = models.BooleanField(default=True, verbose_name="Упоминание в фото")
    comment_user_mention = models.BooleanField(default=True, verbose_name="Упоминание в комментарии к фото")
...
class UserVideoNotifications(models.Model):
    ...
    user_mention = models.BooleanField(default=True, verbose_name="Упоминание в видео")
    comment_user_mention = models.BooleanField(default=True, verbose_name="Упоминание в комментарии к видео")
