...
class OneUserLocation(models.Model):
    ...
    city_lat = models.FloatField(blank=True, blank=True, verbose_name="Ширина города")
    city_lon = models.FloatField(blank=True, blank=True, verbose_name="Долгота города")
...
class UserProfileFamily(models.Model):
    ...
    mom = models.OneToOneField(settings.AUTH_USER_MODEL, blank=True, on_delete=models.CASCADE, related_name='user_profile_mom', verbose_name="Мама")
    dad = models.OneToOneField(settings.AUTH_USER_MODEL, blank=True, on_delete=models.CASCADE, related_name='user_profile_dad', verbose_name="Папа")
