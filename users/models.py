...
class User(AbstractUser):
    ...
    def get_common_friends(self,user_id):
        ...
        query_user = Q()
        frends_ids = [target_user['target_connection_id'] for target_user in connections]
        user_frends_ids = [target_user['target_connection_id'] for target_user in user_connections]
        for frend in frends_ids:
