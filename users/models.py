...
class User(AbstractUser):
    ...
    def get_common_friend2(self):
        ...
        for frend in frends_ids:
            ...
            blocked = ~Q(Q(user__blocked_by_users__blocker_id__in=frend) | Q(user__user_blocks__blocked_user_id__in=frend))
            connections = ~Q(Q(user_id__in=frend) | Q(target_user_id__in=frend))
