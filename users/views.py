...
class ProfileUserView(TemplateView):
	...
	def get(self,request,*args,**kwargs):
		...
		self.posts=Post.objects.filter(creator=self.user,status=STATUS_PUBLISHED)
		self.articles=Article.objects.filter(creator=self.user,status=STATUS_PUBLISHED)
