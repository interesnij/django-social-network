...
class UserPhotoList(TemplateView):
	...
	def get_context_data(self,**kwargs):
		...
		c['user'], c['list'], c['is_user_can_see_photo_section'] = self.user, self.list, self.is_user_can_see_photo_section
		return c
...
class UserPostsListView(ListView):
	...
	def get_context_data(self,**kwargs):
		...
		c['user'],c['post_lists'],c['get_fixed_posts'],c['list'],c['is_user_can_see_post_section'],c['is_user_can_see_post_list'],c['is_user_can_create_posts'] = self.user,self.post_lists,self.user.get_fixed_posts(),self.post_list,self.is_user_can_see_post_section,self.is_user_can_see_post_list, self.is_user_can_create_posts
		return c
