...
urlpatterns = [
    ...
    url(r'^workspace_create_close/(?P<uuid>[0-9a-f-]+)/$', WorkspacePlannerCloseCreate.as_view()),
    url(r'^workspace_delete_close/(?P<uuid>[0-9a-f-]+)/$', WorkspacePlannerCloseDelete.as_view()),
    url(r'^workspace_create_rejected/(?P<uuid>[0-9a-f-]+)/$', WorkspacePlannerRejectedCreate.as_view()),
    url(r'^workspace_create_claim/(?P<uuid>[0-9a-f-]+)/$', WorkspacePlannerClaimCreate.as_view()),
    url(r'^workspace_unverify/(?P<uuid>[0-9a-f-]+)/$', WorkspacePlannerUnverify.as_view()),
    ...
    url(r'^board_create_rejected/(?P<uuid>[0-9a-f-]+)/$', BoardPlannerRejectedCreate.as_view()),
    ...
    url(r'^column_create_rejected/(?P<uuid>[0-9a-f-]+)/$', ColumnPlannerRejectedCreate.as_view()),
    ...
    url(r'^card_create_rejected/(?P<uuid>[0-9a-f-]+)/$', CardPlannerRejectedCreate.as_view()),
