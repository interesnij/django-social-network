...
urlpatterns = [
    url(r'^add_admin/(?P<pk>\d+)/$', GoodAdminCreate.as_view()),
    url(r'^delete_admin/(?P<pk>\d+)/$', GoodAdminDelete.as_view()),
    url(r'^add_moderator/(?P<pk>\d+)/$', GoodModerCreate.as_view()),
    url(r'^delete_moderator/(?P<pk>\d+)/$', GoodModerDelete.as_view()),
    url(r'^add_editor/(?P<pk>\d+)/$', GoodEditorCreate.as_view()),
    url(r'^delete_editor/(?P<pk>\d+)/$', GoodEditorDelete.as_view()),

    url(r'^add_worker_admin/(?P<pk>\d+)/$', GoodWorkerAdminCreate.as_view()),
    url(r'^delete_worker_admin/(?P<pk>\d+)/$', GoodWorkerAdminDelete.as_view()),
    url(r'^add_worker_moderator/(?P<pk>\d+)/$', GoodWorkerModerCreate.as_view()),
    url(r'^delete_worker_moderator/(?P<pk>\d+)/$', GoodWorkerModerDelete.as_view()),
    url(r'^add_worker_editor/(?P<pk>\d+)/$', GoodWorkerEditorCreate.as_view()),
    url(r'^delete_worker_editor/(?P<pk>\d+)/$', GoodWorkerEditorDelete.as_view()),

    url(r'^create_close/(?P<uuid>[0-9a-f-]+)/$', GoodCloseCreate.as_view()),
    url(r'^delete_close/(?P<uuid>[0-9a-f-]+)/$', GoodCloseDelete.as_view()),
    url(r'^create_rejected/(?P<uuid>[0-9a-f-]+)/$', GoodRejectedCreate.as_view()),
    ...
    url(r'^list_create_rejected/(?P<uuid>[0-9a-f-]+)/$', ListGoodRejectedCreate.as_view()),
