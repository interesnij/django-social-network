    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('music', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_audio', to='music.soundcloudparsing', verbose_name='Товар')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('good', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_good', to='goods.good', verbose_name='Товар')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('P', 'Товар рассматривается'), ('D', 'Товар удален'), ('R', 'Товар отвергнут')], default='P', max_length=5, verbose_name='Статус')),
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('comment', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_good_comment', to='goods.goodcomment', verbose_name='Комментарий к товару')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('photo', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_photo', to='gallery.photo', verbose_name='Фотография')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('P', 'Фотография рассматривается'), ('D', 'Фотография удалена'), ('R', 'Фотография отвергнута')], default='P', max_length=5, verbose_name='Статус')),
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('comment', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_photo_comment', to='gallery.photocomment', verbose_name='Комментарий к фотографии')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('post', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_post', to='posts.post', verbose_name='Запись')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('comment', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_post_comment', to='posts.postcomment', verbose_name='Комментарий к записи')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('video', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_video', to='video.video', verbose_name='Ролик')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('P', 'Ролик рассматривается'), ('D', 'Ролик удален'), ('R', 'Ролик отвергнут')], default='P', max_length=5, verbose_name='Статус')),
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('comment', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderated_video_comment', to='video.videocomment', verbose_name='Комментарий к ролику')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='video_comment_penalties', to='video.videocomment', verbose_name='Оштрафованный комментарий к ролику')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='video_penalties', to='video.video', verbose_name='Оштрафованный ролик')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('type', models.CharField(choices=[('D', 'Удалено')], max_length=5, verbose_name='Тип')),
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_comment_penalties', to='posts.postcomment', verbose_name='Оштрафованный комментарий к записи')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_penalties', to='posts.post', verbose_name='Оштрафованная запись')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('type', models.CharField(choices=[('D', 'Удалено')], max_length=5, verbose_name='Тип')),
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photo_comment_penalties', to='gallery.photocomment', verbose_name='Оштрафованный комментарий к фотографии')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photo_penalties', to='gallery.photo', verbose_name='Оштрафованная фотография')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('type', models.CharField(choices=[('D', 'Удалено')], max_length=5, verbose_name='Тип')),
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='good_comment_penalties', to='goods.goodcomment', verbose_name='Оштрафованный комментарий к товару')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('type', models.CharField(choices=[('D', 'Удалено')], max_length=5, verbose_name='Тип')),
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('good', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='good_penalties', to='goods.good', verbose_name='Оштрафованный товар')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('type', models.CharField(choices=[('D', 'Удалено')], max_length=5, verbose_name='Тип')),
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('audio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audio_penalties', to='music.soundcloudparsing', verbose_name='Оштрафованный трек')),
