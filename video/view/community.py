...
class CommunityVideoList(ListView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        self.template_name = self.community.get_template(folder="c_album_list/", template="list.html", request=request)
...
class CommunityVideoDetail(TemplateView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        self.template_name = self.community.get_template(folder="c_video_detail/", template="video.html", request=request)
